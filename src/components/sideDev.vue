...
const menus = [
    { name: 'Dashboard', path: '/dev-area' },
    { name: 'User Contact', path: '/dev-area/user/contact' },
    { name: 'Notifications', path: '/dev-area/notifications' }
]
    ...
    <div v-if="isShow" class="fixed inset-0 z-40 lg:hidden">
        ...
        <aside class="border-r border-neutral-300 bg-black lg:block fixed top-0 left-0 h-screen w-56 bg-slate-100">
            <div class="bg-neutral-100 p-4 flex items-center">
                ...
                <span class="font-semibold ml-2 text-[1.2rem] font-sans">Adico Developer</span>
            </div>
