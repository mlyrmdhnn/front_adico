    ...
    <SalesmanLayout>
        ...
        <div class="mb-6 overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-sm">
            ...
            <form class="flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center" @submit.prevent="attendance">
                ...
                <button type="submit"
                    class="inline-flex items-center justify-center rounded-md bg-blue-600 px-5 py-2 text-sm font-medium text-white transition hover:bg-blue-700 active:scale-[0.98]">
                    Submit
                </button>
            </form>
        </div>
        ...
        <div class="overflow-x-auto mb-6 rounded-lg border border-neutral-200 bg-white shadow-sm">
            <section class="flex items-center gap-4 px-4 py-4 bg-neutral-50">
                ...
                <!-- Card 2 -->
                <!-- <router-link to="/salesman/monthly-customer-recap/pdf?type=last-month"
                    class="group w-56 p-4 rounded-lg border bg-white hover:shadow-md transition">
                    <div class="flex items-center gap-3">
                        <div class="p-2 rounded bg-emerald-100 text-emerald-600">
                            <FileText />
                        </div>
                        <div>
                            <p class="text-sm text-neutral-500">Export</p>
                            <h3 class="font-semibold text-neutral-900 group-hover:text-emerald-600">
                                Bulan Lalu
                            </h3>
                        </div>
                    </div>
                ...
                <!-- Card 3 -->
                <router-link to="/salesman/store-range-recap/pdf"
                    class="group w-56 p-4 rounded-lg border bg-white hover:shadow-md transition">
                    <div class="flex items-center gap-3">
                    ...
                    <p class="mt-2 text-xs text-neutral-500">
                        Pilih rentang tanggal manual data store
                    </p>
                </router-link>
